            ...
            window,
                (t.exports = (function (t) {
                    ...
                    function (t, e, o) {
                                    ...
                                    _keyboard(t) {
                                        ...
                                        if (document.activeElement === o.wrapper) {
                                            ...
                                            if ("keydown" === n && (r || s || c || a)) {
                                                let t = 0,
                                                    n = 0;
                                                "v" === o ? (t = r || s ? 1 : -1) : "h" === o ? (t = r || s ? -1 : 1) : ((n = r ? -1 : c ? 1 : 0), (t = a ? -1 : s ? 1 : 0)), e.update(x(e.cache.x + 0.01 * t), x(e.cache.y + 0.01 * n));
                            ...
                            return {
                                update(s) {
                                    const { position: c, variant: a, isVertical: l } = r(s),
                                        ...
                                        h = (t) => (t ? { t: p.top - u.height - o, b: p.bottom + o } : { r: p.right + o, l: p.left - u.width - o }),
                                        d = (t) => (t ? { s: p.left + p.width - u.width, m: -u.width / 2 + (p.left + p.width / 2), e: p.left } : { s: p.bottom - u.height, m: p.bottom - p.height / 2 - u.height / 2, e: p.bottom - p.height }),
                                        f = {};
                                    function m(e, o, n) {
                                        const i = "top" === n,
                        ...
                        var R = ({ components: t, strings: e, useAsButton: o, inline: n, appClass: i, theme: r, lockOpacity: s }) => {
                            const c = (t) => (t ? "" : 'style="display:none" hidden'),
                                a = h(
                                    '\n      <div :ref="root" class="pickr">\n\n        '
                                        ...
                                        .concat(i || "", '" data-theme="')
                                        .concat(r, '" ')
                                        .concat(n ? 'style="position: unset"' : "", ' aria-label="color picker dialog" role="window">\n          <div class="pcr-selection" ')
                        ...
                        class D {
                            constructor(t) {
                                ...
                                (this._nanopop = E({ reference: u, padding: s, el: h })), u.setAttribute("role", "button"), u.setAttribute("aria-label", "toggle color picker dialog");
                                const d = this;
                            ...
                            _rePositioningPicker() {
                                ...
                                if (!t.inline) {
                                    ...
                                    matchMedia("(max-width: 576px)").matches
                                        ? Object.assign(e.style, { margin: "auto", height: "".concat(e.getBoundingClientRect().height, "px"), top: 0, bottom: 0, left: 0, right: 0 })
                                        : (Object.assign(e.style, { margin: null, right: null, top: null, bottom: null, left: null, height: null }), this._nanopop.update(t.position));
                                }
                            }
                            _updateOutput() {
                        ...
                        (D.utils = n), (D.libs = { HSVaColor: j, Moveable: P, Nanopop: E, Selectable: L }), (D.create = (t) => new D(t)), (D.version = g.a), (e.default = D);
                    },
                ]).default);
        },
        function (t, e, o) {},
        function (t, e, o) {
            ...
            function u(t) {
                ...
                for (let t = 0; t < n.length; t++) {
                    ...
                    else if (u.length) for (const t of u) i.push({ loc: t, color: a || s });
                    else r || (r = e);
                    s = a || s;
                }
            ...
            class b {
                constructor(t) {
                    f(this, "_stops", []),
                        ...
                        (this._root = r(t)),
                        CSS.supports("background-image", "conic-gradient(#fff, #fff)") && this._modes.push("conic"),
                        (t.el = t.el.split(/>>/g).reduce((t, e, o, n) => ((t = t.querySelector(e)), o < n.length - 1 ? t.shadowRoot : t), document)),
                        ...
                        (this._pickr = i.a
                            .create({
                                ...
                                components: { palette: !0, preview: !0, opacity: !0, hue: !0, interaction: { input: !0 } },
                            })
                            .on("change", (t) => {
                ...
                _render(t = !1) {
                    ...
                    for (const { color: t, el: e, loc: o } of c) Object.assign(e.style, { left: `${100 * o}%`, color: t });
                    (n.style.transform = `rotate(${l - 90}deg)`),
                        (e.style.background = `linear-gradient(to right, ${this.getStops().toString("linear")})`),
                ...
                removeStop(t) {
                    const { _stops: e } = this,
                        o = (() => ("number" == typeof t ? e.find((t) => t.loc === t) : "string" == typeof t ? e.find((t) => t.color === t) : "object" == typeof t ? t : void 0))();
                        
                    // e.splice(e.indexOf(o), 1), o.el.remove(), v(...o.listener), this._focusedStop === o && (this._focusedStop = e[0]), this._render();

                    for (let c of e) {
                        console.log("COres",c.color.split(', 1)').join(')').split(" ").join("").split("rgba").join("rgb").trim(),t.split(" ").join("").split("rgba").join("rgb").trim());
                        if (c.color.split(', 1)').join(')').split(" ").join("").split("rgba").join("rgb").trim()==t.split(" ").join("").split("rgba").join("rgb").trim()){
                            console.log("ELIMINA!",this)
                            
                            this._stops = e.splice(c,1);
                        }
                ...
                getStops() {
                    const t = this._stops.map((t) => ({ color: t.color, location: t.loc })),
                        e = this._mode;
                    return (
